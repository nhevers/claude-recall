...
function printHelp(): void {
  console.log(`
bug-report - Generate bug reports for claude-recall
...
DESCRIPTION:
  ...
  and generates a formatted GitHub issue for claude-recall using the Claude Agent SDK.
...
async function main() {
  ...
  console.log(`   claude-recall: v${diagnostics.versions.ClaudeRecall}`);
  ...
  const githubUrl = `https://github.com/nhevers/claude-recall/issues/new?title=${encodedTitle}&body=${encodedBody}`;
